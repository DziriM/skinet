    ...
    IHubContext<NotificationHub> hubContext) : BaseApiController
{
    ...
    [Authorize]
    [HttpPost("{cartId}")]
    public async Task<ActionResult<ShoppingCart>> CreateOrUpdateShoppingCart(string cartId)
    {
    ...
    public async Task<IActionResult> StripeWebhook()
    {
        ...
        {
            // for debug purpose
            logger.Log(LogLevel.Information, _whSecret);
    ...
    private Event ConstructStripeEvent(string json)
    {
        try
        {
            // We are cheking the Json we get from the request and comparing it to our stripe secret
